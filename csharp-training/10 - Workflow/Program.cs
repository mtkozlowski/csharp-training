...
namespace _10___Workflow
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var workflowEngine = new List<IWorkflow>();
            workflowEngine.Add(new DoSomething());

            foreach (var workflow in workflowEngine)
            {
                workflow.Execute();
            }
        }
    ...
    public class DoSomething : IWorkflow
    {
        public void Execute()
        {
